	...
	return (
		<section className='relative'>
			...
			<div className='relative max-w-6xl mx-auto px-4 sm:px-6'>
				<div className='py-12 md:py-20' id='about'>
					{/* Section header */}
					<div className='max-w-3xl mx-auto text-center pb-12 md:pb-20'>
						<h2 className='h2 mb-4'>
							How Habit<span className='bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400'>Traker </span>works
						</h2>
						<p className='text-xl text-gray-600'>
							HabitTraker provides a plethora of features which facilitate consistency with your goals and bring you one step closer to your dream
							self!
						</p>
					</div>
